package com.ohtel.ohtel.customwidgets;
...
public class CustomNavigationView extends ScrimInsetsFrameLayout {
    ...
    private static FooterClickListener footerClickListener;
    private int state = FULL_SCROLLABLE;
    private boolean isHeaderDrawn = false;
    private boolean isFooterDrawn = false;
    ...
    public void setFooterView(View view, int marginBottom) {
        if (state == FULL_SCROLLABLE) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            layoutParams.setMargins(0, 0, 0, marginBottom);
    ...
    public void setOnFooterSelectedListener(FooterClickListener footerClickListener) {
        CustomNavigationView.footerClickListener = footerClickListener;
    }
